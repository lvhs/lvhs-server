...
ActiveRecord::Schema.define(version: 20_150_126_065_248) do
  ...
  add_index 'reward_histories', %w(cid device_id action_date pid), name: 'conversion', unique: true, using: :btree
